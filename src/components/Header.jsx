...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
      ...
      <p className='text-center max-w-xl mx-auto mt-5'>Generate stunning AI-powered images from text prompts instantly. Just describe your vision, and let our AI bring it to life!"</p>
